=========================================
Welcome to generative-over-sampling documentation!
=========================================
...
`Release history <release_history.html>`_ and `about <about.html>`_ section of generative-over-sampling.

See the `README <https://github.com/IMS-ML-Lab/generative-over-sampling/blob/master/README.rst>`_
